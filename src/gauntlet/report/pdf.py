...
class GauntletPDF(FPDF if FPDF else object):
    """Custom PDF class with Gauntlet branding."""
    ...
    def header(self):
        ...
        self.cell(0, 5, "GAUNTLET", align="L")
    ...
    def add_cover_page(self, report_type, date_range=None):
        ...
        self.set_text_color(*COLOR_RED)
        self.cell(0, 15, "GAUNTLET", align="C", new_x="LMARGIN", new_y="NEXT")
        self.ln(5)
...
class ReportGenerator:
    ...
    def red_team_report(self, session_id=None, stats=None, results=None):
        ...
        pdf = GauntletPDF("Red Team Assessment Report")
        pdf.alias_nb_pages()
