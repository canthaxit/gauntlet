...
and helper functions for the Gauntlet REST API.
...
from gauntlet.storage import RedTeamResultsDB
...
# --- Audit Logger ---
_audit_log = logging.getLogger("gauntlet.dungeon.audit")
...
# --- Unified storage backend (optional, set by gauntlet_security.py) ---
...
def set_unified_storage(backend):
    ...
    (typically SQLiteBackend -> gauntlet.db) instead of RedTeamResultsDB.
    """
...
def _require_api_key(f):
    ...
    def decorated(*args, **kwargs):
        api_key = os.getenv("GAUNTLET_API_KEY", "")
        if not api_key:
...
def _get_scheduler():
    ...
    if _scheduler is None:
        with _scheduler_init_lock:
            if _scheduler is None:
                from gauntlet.scheduler import get_scheduler
...
import gauntlet.api.routes.scenarios  # noqa: E402, F401
import gauntlet.api.routes.execution  # noqa: E402, F401
import gauntlet.api.routes.sessions   # noqa: E402, F401
import gauntlet.api.routes.scheduler  # noqa: E402, F401
import gauntlet.api.routes.tools      # noqa: E402, F401
import gauntlet.api.routes.reports    # noqa: E402, F401
