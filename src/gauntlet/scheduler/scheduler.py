...
Usage:
    from gauntlet.scheduler import RedTeamScheduler
...
from gauntlet.core.models import DEFAULT_TARGET_URL
...
class RedTeamScheduler:
    ...
    def _execute_run(self, run_id, config, job_id=None):
        ...
        try:
            from gauntlet.core import RedTeamOrchestrator, _default_scenarios_path
