"""
PyRIT (Microsoft) adapter for Gauntlet Red Team Engine.
...
Key classes:
    GauntletPromptTarget  - PyRIT PromptTarget backed by our /api/chat endpoint.
...
from gauntlet.core.models import AttackScenario, TestResult, AttackResult
...
# ---------------------------------------------------------------------------
# GauntletPromptTarget
# ---------------------------------------------------------------------------

class GauntletPromptTarget:
...
class PyRITAdapter(RedTeamToolAdapter):
    """Adapter that bridges PyRIT into the Gauntlet red team engine."""
    ...
    def run_attack(self, prompt: str, target_url: str, **kwargs) -> TestResult:
        ...
        target = GauntletPromptTarget(target_url, api_key=self.api_key, timeout=self.timeout)
