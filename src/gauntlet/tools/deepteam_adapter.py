"""
DeepTeam (Confident AI) adapter for Gauntlet Red Team Engine.
...
class DeepTeamAdapter(RedTeamToolAdapter):
    """Adapter that bridges DeepTeam into the Gauntlet red team engine."""
    ...
    def _map_vulnerabilities(self, categories: Optional[List[str]] = None) -> List[str]:
        """Map Gauntlet AttackCategory names to DeepTeam vulnerability names.

        Args:
            categories: Gauntlet category names (e.g. "prompt_injection").
