"""
AIX Framework adapter for Gauntlet Red Team Engine.
...
Fork: https://github.com/canthaxit/aix-framework
...
# Map AIX modules to Gauntlet attack categories
...
class AixAdapter(RedTeamToolAdapter):
    """Adapter that bridges AIX Framework into the Gauntlet red team engine.
    ...
    def _severity_to_difficulty(severity: str) -> str:
        """Map AIX severity to Gauntlet difficulty level."""
        mapping = {
            "critical": "advanced",
            "high": "hard",
            "medium": "medium",
