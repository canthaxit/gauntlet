...
from gauntlet.core.models import AttackScenario, TestResult
...
class ToolManager:
    ...
    def _discover_tools(self) -> None:
        ...
        adapter_specs = [
            ("pyrit", "gauntlet.tools.pyrit_adapter", "PyRITAdapter"),
            ("deepteam", "gauntlet.tools.deepteam_adapter", "DeepTeamAdapter"),
            ("aix", "gauntlet.tools.aix_adapter", "AixAdapter"),
        ]
        ...
        **kwargs,
        ...
        if not adapter.is_available():
            raise RuntimeError(
                ...
                f"Install with: pip install gauntlet[{tool_name}]"
            )
