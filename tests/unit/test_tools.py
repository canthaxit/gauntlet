...
from gauntlet.core import AttackScenario, TestResult, AttackResult
...
class TestRedTeamToolAdapter:
    def test_abstract_methods_cannot_instantiate(self):
        from gauntlet.tools.base import RedTeamToolAdapter
...
class TestGauntletPromptTarget:
    def test_send_success(self, mock_target_response):
        from gauntlet.tools.pyrit_adapter import GauntletPromptTarget

        target = GauntletPromptTarget("http://localhost:5000/api/chat")
...
class TestPyRITAdapter:
    def test_is_available_no_pyrit(self):
        from gauntlet.tools.pyrit_adapter import PyRITAdapter
        import gauntlet.tools.pyrit_adapter as mod
    ...
    def test_run_attack_blocked(self, mock_target_response):
        ...
        with patch("gauntlet.tools.pyrit_adapter.GauntletPromptTarget") as MockTarget:
...
class TestDeepTeamAdapter:
    def test_is_available_no_deepteam(self):
        from gauntlet.tools.deepteam_adapter import DeepTeamAdapter
        import gauntlet.tools.deepteam_adapter as mod
    ...
    def test_map_vulnerabilities_all(self):
        from gauntlet.tools.deepteam_adapter import DeepTeamAdapter, DEEPTEAM_VULNS
    ...
    def test_run_attack_blocked(self, mock_target_response):
        ...
        with patch("gauntlet.tools.deepteam_adapter.requests.Session") as MockSession:
            mock_sess = MagicMock()
            mock_resp = MagicMock()
            mock_resp.json.return_value = mock_target_response
            mock_resp.raise_for_status = MagicMock()
...
class TestDeepTeamVulnMapping:
    def test_all_categories_mapped(self):
        from gauntlet.tools.deepteam_adapter import CATEGORY_TO_DEEPTEAM
    ...
    def test_reverse_mapping_exists(self):
        from gauntlet.tools.deepteam_adapter import DEEPTEAM_TO_CATEGORY
    ...
    def test_vulns_list_populated(self):
        from gauntlet.tools.deepteam_adapter import DEEPTEAM_VULNS
...
class TestGarakImporter:
    def test_fallback_probes_no_path(self):
        from gauntlet.tools.garak_importer import GarakImporter
...
class TestToolManager:
    def test_discovery(self):
        from gauntlet.tools.tool_manager import ToolManager
...
class TestPackageInit:
    def test_available_tools(self):
        from gauntlet.tools import available_tools
    ...
    def test_imports(self):
        from gauntlet.tools import RedTeamToolAdapter, ToolManager
...
class TestDungeonAPITools:
    """Test the tool endpoints in gauntlet.api."""

    @pytest.fixture
    def client(self):
        from flask import Flask
        from gauntlet.api import dungeon_bp
